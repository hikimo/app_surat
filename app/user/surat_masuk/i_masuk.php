			...
			<div class="w3-container">
				<form method="POST">
					...
					<p>
						...
						<input type="text" name="pengirim" class="w3-input" id="pengirim" required>
					</p>
...
if(isset($_POST['simpan']))
{
	...
	$sql = "INSERT INTO surat_masuk(id,jenis_surat,tanggal_kirim,tanggal_terima,no_surat,pengirim,perihal) VALUES('$id','$jenis_surat','$tanggal_kirim','$tanggal_terima','$no_surat', '$pengirim', '$perihal')";
