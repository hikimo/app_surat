...
include '../layouts/header-mas.php';
include '../../system/koneksi.php';
?>

	<div class="w3-container w3-padding-bottom" style="padding-top: 22px">
		<h2><b>Data Surat Masuk</b></h2>
		<div class="w3-container-padding">
			<div class="w3-third">
				<a class="w3-btn w3-teal" href="i_masuk.php"><i class="fa fa-plus"></i> Tambah Surat Masuk</a>
			</div>
			...
			<div class="w3-card-4 w3-margin-bottom">
				<table class="w3-table w3-stripped w3-bordered">
					...
					<tbody>
						...
						if($klik){
							$sql = "SELECT * FROM surat_masuk WHERE no_agenda LIKE '%$cari%' OR id LIKE '%$cari%' OR jenis_surat LIKE '%$cari%' OR tanggal_kirim LIKE '%$cari%' OR tanggal_terima LIKE '%$cari%' OR no_surat LIKE '%$cari%' OR pengirim LIKE '%$cari%' OR perihal LIKE '%$cari%'";
						...
						?>
							<tr>
								...
								<td><?= $row['perihal']?></td>
								<td>
									<a class="w3-btn w3-orange w3-text-white" href="e_masuk.php?no_agenda=<?= $row['no_agenda'] ?>"><i class="fa fa-edit"></i></a>
...
if(isset($_GET['no_agenda']))
{
	...
	$sql = "DELETE FROM surat_masuk WHERE no_agenda=$h_no";
	// Jalankan query
	if($konek->query($sql))
	{
