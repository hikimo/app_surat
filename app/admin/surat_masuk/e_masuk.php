...
{
	$g_no = $_GET['no_agenda'];
	$q_e = "SELECT * FROM surat_masuk WHERE no_agenda=$g_no";
			...
			<div class="w3-container">
				<form method="POST">
					...
					<p>
						...
						<input type="date" name="tanggal_terima" value="<?= $hasil['tanggal_terima']?>" class="w3-input" id="tanggal_terima" required>
					</p>
...
if(isset($_POST['simpan']))
{
	...
	$sql = "UPDATE surat_masuk SET id='$id', jenis_surat='$jenis_surat', tanggal_kirim='$tanggal_kirim', tanggal_terima='$tanggal_terima', no_surat='$no_surat', pengirim='$pengirim', perihal='$perihal' WHERE no_agenda=$g_no";
